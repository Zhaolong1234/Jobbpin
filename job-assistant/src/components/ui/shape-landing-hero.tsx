      ...
      >
        <div
          className={cn(
            ...
            gradient,
            "backdrop-blur-[2px] border-2 border-white/[0.18]",
...
function ShapeLandingBackground({ className }: { className?: string }) {
  return (
    <div className={cn("pointer-events-none fixed inset-0 -z-10 overflow-hidden", className)} aria-hidden>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_18%,rgba(56,189,248,0.12),transparent_40%),radial-gradient(circle_at_82%_12%,rgba(99,102,241,0.12),transparent_38%),radial-gradient(circle_at_68%_82%,rgba(244,114,182,0.1),transparent_42%)]" />
