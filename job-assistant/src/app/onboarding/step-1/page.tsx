...
export default function Step1Page() {
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white px-6 py-8 shadow-panel md:px-10 md:py-10">
      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-6">
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6 text-center">
          ...
          <p className="mt-2 text-4xl font-black tracking-tight text-slate-900 md:text-6xl">
          ...
          {ROLE_OPTIONS.map((role) => {
            ...
            return (
              <button
                ...
                className={`rounded-full border px-4 py-2 text-sm transition duration-200 motion-reduce:transition-none ${
                  selected
